...
const VoiceAssistant: React.FC<VoiceAssistantProps> = ({
  ...
  return (
    <div className={`bg-white rounded-xl p-6 shadow-sm border border-gray-100 ${isActive ? 'ring-2 ring-blue-500' : ''}`}>
      ...
      <div className="flex items-center justify-center space-x-4 mb-6">
        ...
        <button
          onClick={isSpeaking ? stopSpeaking : () => speakText('नमस्ते! मैं आपका AI सहायक हूँ। मैं आपकी व्यापारिक जरूरतों में मदद कर सकता हूँ।')}
          ...
          <div className="flex items-center justify-center space-x-1 h-12">
            {[...Array(20)].map((_, i) => (
              <div
                ...
                style={{
                  height: `${Math.max(4, (Math.sin(Date.now() * 0.01 + i) + 1) * 20 + audioLevel * 0.3)}px`
                }}
              ></div>
            ))}
          </div>
      ...
      <div className="grid grid-cols-2 gap-2">
        <button
          onClick={() => speakText(translationService.translate('welcome', selectedLanguage))}
      ...
      <div className="mt-4 p-3 bg-blue-50 rounded-lg">
        <p className="text-xs text-blue-600 mb-1">Voice Commands in {getLanguageName(selectedLanguage)}:</p>
